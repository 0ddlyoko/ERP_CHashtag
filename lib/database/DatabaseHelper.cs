...
public static class DatabaseHelper
{
    ...
    public static async Task CreateColumn(DatabaseConnection connection, string tableName, string columnName, string columnType, string? columnDescription = null, bool? required = null, string? targetTableName = null, string? targetColumnName = null)
    {
        ...
        {
            await MakeRelationBetweenColumns(connection, tableName, columnName, targetTableName, targetColumnName);
        }
    }

    public static async Task MakeRelationBetweenColumns(DatabaseConnection connection, string tableName,
        string columnName, string targetTableName, string targetColumnName)
    {
